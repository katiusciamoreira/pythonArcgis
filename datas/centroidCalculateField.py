# Usar a função Calculate Field para adicionar as coordenadas x e y dos centroides de uma feição, 
# criando estes campos na tabela de atributos da feição desejada
# Válido para arquivos classes de feição do tipo poligono, linha e ponto..etc)
# Obs.: No caso de pontos as coordenadas centrais adicionadas coincidirão com as mesmas da localização do ponto
...
# Para este codigo usei algumas bases da documentação do arcgis disponivel em: http://resources.arcgis.com/en/help/main/10.1/index.html#//00170000004m000000